"""Detailed analysis workflow for: Image-based cell phenotyping with deep learning"""
...
CLASS_SHIFT = 0.9
ASSETS = Path("assets")
FEATURE_NAMES = ['area', 'perimeter', 'eccentricity', 'texture_entropy', 'intensity_mean', 'intensity_std', 'solidity', 'aspect_ratio']
...
def create_visualization(artifacts: dict) -> Path:
    ...
    if kind == "target_score_distribution":
        ...
        axes[0].set_title("Image-based Cell Phenotyping\nPredicted Target Priority Scores")
...
def run() -> None:
    ...
    print("Topic: Image-based cell phenotyping with deep learning")
    print(
