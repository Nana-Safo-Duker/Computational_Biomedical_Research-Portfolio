...
CLASS_SHIFT = 0.55
ASSETS = Path("assets")
FEATURE_NAMES = ['binding_affinity', 'sequence_conservation', 'structure_score', 'offtarget_risk', 'assay_activity', 'chemogenomic_hit', 'ppi_degree', 'go_similarity']
...
def create_visualization(artifacts: dict) -> Path:
    ...
    if kind == "target_score_distribution":
        ...
        axes[0].set_title("Drug Target Identification\nPredicted Target Priority Scores")
...
def run() -> None:
    ...
    print("Topic: Machine Learning for Drug Target Identification in Bioinformatics")
    print(
